...
router.post('/admin/signup', (req, res) => {
    ...
    connect.query(
        `INSERT INTO tbl_user (user_fname, user_name, user_pass, user_email, user_admin, user_access, account_id) `+
        `VALUES("${req.body.fname}", "${req.body.username}", "${req.body.password}", "${req.body.email}", "${req.body.admin}", "${req.body.access}", "3") `,
