...
//* need to add rating in table and put the highest rated sort by heightest rating
//* could make them pick there favourite genres then only get those and sort by rating
...
router.get('/movies/:id', (req, res) => {
    ...
    connnect.query(
        ...
        if (error) throw error;
        console.log('results: ', results[0], "fields: ", fields);
